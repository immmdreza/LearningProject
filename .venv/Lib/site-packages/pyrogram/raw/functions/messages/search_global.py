...
class SearchGlobal(TLObject):  # type: ignore
    ...
    ID = 0xbf7225a4
    QUALNAME = "pyrogram.raw.functions.messages.SearchGlobal"

    def __init__(self, *, q: str, offset_rate: int, offset_peer: "raw.base.InputPeer", offset_id: int, limit: int, folder_id: Union[None, int] = None) -> None:
        self.q = q  # string

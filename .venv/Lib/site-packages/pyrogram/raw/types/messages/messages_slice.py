...
class MessagesSlice(TLObject):  # type: ignore
    ...
    ID = 0xc8edce1e
    QUALNAME = "pyrogram.raw.types.messages.MessagesSlice"

    def __init__(self, *, count: int, messages: List["raw.base.Message"], chats: List["raw.base.Chat"], users: List["raw.base.User"], inexact: Union[None, bool] = None, next_rate: Union[None, int] = None) -> None:
